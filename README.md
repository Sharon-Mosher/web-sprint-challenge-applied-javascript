...
1. What is the DOM? DOM is Document Object Model

2. What is an event? An event occurs when some sort of interaction takes place in a web page.

3. What is an event listener? An event listener is a procedurein Java Script that waits for an event to occur.

4. Why would we convert a NodeList into an Array? We would convert an NodeList to an Array so we can use the data in Java Script. A NodeList is a browswerAPI and an array is a Java Script API.

5. What is a component? A component is independent and reusable bits of code.
